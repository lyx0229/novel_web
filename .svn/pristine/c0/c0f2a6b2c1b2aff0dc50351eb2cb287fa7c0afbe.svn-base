...
public class WXLoginController {
	...
	@RequestMapping(value="/access",  method = {RequestMethod.POST,RequestMethod.GET})
	public @ResponseBody String WeChatInterface(HttpServletRequest request, HttpServletResponse response)throws Exception{
	    ...
	    public String callBack(ModelMap modelMap,HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	      ...
	      //第二步：通过code换取网页授权access_token
	       ...
	       String infoUrl = "https://api.weixin.qq.com/sns/userinfo?access_token="+access_token
	        ...
	        userInfo.put("scheme_id", 0);
	        if(userInfo.containsKey("openid") && !userInfo.getString("openid").isEmpty())
	        {
						 ...
						 */
							 ...
							 */
							    ...
							    public String wxl_campaign(HttpServletRequest request,
							    	    ...
							    	    String backUrl=businessConfig.DOMAIN_URL+"/wx/wxl_campaign_back?param="+param+"&scheme_id="+scheme_id;
							 ...
							 */
							    ...
							    public String wxl_campaign_back(ModelMap modelMap,HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
							        ...
							        String scheme_id =req.getParameter("scheme_id");
							        logger.info("code:"+code);
							        logger.info("param:"+param);
							        logger.info("scheme_id:"+scheme_id);
							      //第二步：通过code换取网页授权access_token
							         String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid="+businessConfig.APPID
							                + "&secret="+businessConfig.APPSECRET
							                + "&code="+code
							       ...
							       String infoUrl = "https://api.weixin.qq.com/sns/userinfo?access_token="+access_token
							        ...
							        userInfo.put("scheme_id", scheme_id);
							        if(userInfo.containsKey("openid") && !userInfo.getString("openid").isEmpty())
							        {
						        	logger.info("更新用户信息");
							        WeixinUserInfo weixinUserInfo =userService.saveOrUpdateUserInfo(userInfo);
