...
import com.weixin.constants.WXPayConstants;
import com.weixin.constants.WXPayConstants.SignType;
...
public class WXPayUtil {
	...
	public static Map<String,Object> createOrderInfo(Map<String, String> requestMap) {  
	    ...
	    try {
			unifiedOrderRequest.setSign(generateSignature(packageParams,"VxIWevPj37CdLYxK0vU6gH7STkGb9g1O"));//签名
		} catch (Exception e) {
			e.printStackTrace();
		}
	    //将订单对象转为xml格式  
	...
	private static String createSign(UnifiedOrderRequest unifiedOrderRequest) {  
	    ...
	    sb.append("key="+"VxIWevPj37CdLYxK0vU6gH7STkGb9g1O");  
